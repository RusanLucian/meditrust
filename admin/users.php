...
$query  = "SELECT id, name, email, user_type, phone, specialty FROM users WHERE 1=1";
$params = [];
$types  = '';
            ...
            <div class="admin-card-header">
                ...
                <div class="section-toolbar">
                    ...
                    <form method="GET" action="users.php" class="filter-bar">
                        <input type="text" name="search" placeholder="🔍 Caută după nume / email..."
                        ...
                        <select name="type">
                            ...
                            <option value="medic"   <?php echo $filterType === 'medic'   ? 'selected' : ''; ?>>Medic</option>
                            <option value="patient" <?php echo $filterType === 'patient' ? 'selected' : ''; ?>>Patient</option>
                            <option value="pacient" <?php echo $filterType === 'pacient' ? 'selected' : ''; ?>>Pacient</option>
                        </select>
